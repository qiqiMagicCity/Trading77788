...
/* === v7.16 price history integration === */
import { fetchDailySeries } from './services/priceService.js';

document.addEventListener('DOMContentLoaded', async () => {
  const symbols = window.trackedSymbols || ['AAPL']; // fallback
  await fetchDailySeries(symbols);
  console.log('Daily series updated & cached');
});
